        ...
        <div class="myshopping m_10">
            <ul class="order_step">
                <li class="current_prev"><span class="first"><a
                        href='javascript:window.history.go(-2);'>1、查看购物车</a></span></li>
                <li class="current"><span>2、填写核对订单信息</span></li>
                <li class="last"><span>3、成功提交订单</span></li>
            </ul>
        </div>

        <form action='./order/settle' method='post' name='order_form'
              id="form1">
            ...
            <div class="cart_box m_10">
                    ...
                    <div class="wrap_box">
                        ...
                        <table width="100%" class="cart_table t_c">
                            ...
                            <c:forEach items="${goodses}" var="goods" varStatus="s">
                                <input type="hidden" name="orderHasGoodsList[${s.index }].gid"
                                       value="${goods.gid}" />
                                <input type="hidden" name="orderHasGoodsList[${s.index }].num"
                                       value="${num[s.index]}" />

                                <!--实售价-->
                                <input type="hidden" name="orderHasGoodsList[${s.index }].price"
                                       value="${goods.price}" />
                                <tr>
                                    ...
                                    <td>${num[s.index]}</td>
                                    <td>￥<b class="red2">${cost[s.index]}</b></td>
                                </tr>
                                <!-- 商品展示 结束-->
                            </c:forEach>
                            </tbody>
                ...
                <input type='hidden' name='totalcost' value='${totalcost+fee}'/>
            <!--金额结算-->
            <div class="cart_box" id='amountBox'>
                <div class="cont_2">
                    ...
                    <div class="pink_box">
                        <p class="f14 t_l">
                            商品总金额：<b>${totalcost}</b> + 手续费总计：<b id='delivery_fee_show'>${fee}</b>
                        </p>
                    </div>
                    <hr class="dashed" />
                        ...
                        <table width="100%" class="form_table t_l">
                            ...
                            <tr>
                                <td class="t_r"><b class="price f14">应付总额：<span
                                        class="red2">￥<b id='final_sum'>${totalcost+fee}</b></span>元
                                </b></td>
                            </tr>
                        </table>
                    </div>
